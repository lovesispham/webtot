jQuery(document).ready(function($) {
    ...
    $(".fa-title").on("click", function() {
        ...
        $(this).parent().find(".fa-menu").slideToggle(function() {
    ...
    $(".f-title").on("click", function() {
        $(this).toggleClass('active');
        $(this).parent().find(".f-menu").slideToggle(function() {
            $(this).next().stop(true).toggleClass('open', $(this).is(":visible"));
        });
    });
    
    //Check form Contact
    $(".width-label .form-control").change(function(){

        $(this).next().css({'opacity':'1',"margin-left" : "0","transform": "translateY(-96px)"});
    ...
    // JS owl product related Carousel 
    $('.js-product-related').owlCarousel({
        ...
        //Loading
          jQuery('.progress-bar-loading').each(function() {
...
/* Sticky Header */
  ...
  if (!IsMobile()){
    ...
    /* viet code js tren Mobile */
    /* Parallax */
     var scene = document.getElementById('scene');
     var parallaxInstance = new Parallax(scene, {
       relativeInput: true
     });
     parallaxInstance.friction(0.4, 0.6);   
